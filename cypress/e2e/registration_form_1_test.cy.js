...
describe('This is first test suite, Raul Viikna', () => {
    ...
    */
    ...
    it('User cannot submit data when phone number is absent', () => {
        ...
        //cy.get('input[id="phoneNumber"]').should('have.attr', 'title').should('contain', 'Input field')
